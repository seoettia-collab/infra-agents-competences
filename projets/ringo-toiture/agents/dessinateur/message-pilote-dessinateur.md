...
## Contenu
## Mission active — visualisation client Ringo Toiture Bondy
...
Objectif : produire une maquette de présentation permettant au client de voir
la toiture et les fournitures prévues. Il ne s'agit pas d'un dossier structure
d'exécution. Les éléments porteurs hors toiture sont à modéliser comme support
plausible et clairement standard/provisoire.
...
- Usage attendu : rendu/maquette explicative client, pas plans définitifs.
...
- Brisis à forte pente, ordre de grandeur 70°.
- Terrasson à faible pente, ordre de grandeur 15° à 20°.
- Ligne de bris matérialisée par zinguerie.
- Couverture ardoise 20 x 30 cm gris anthracite, pose au crochet.
- Écran HPV, contre-lattage, liteaunage, charpente bois traité classe 2.
...
- Annoter dans Revit/rapport les éléments standard de visualisation :
  fondations, dalle, murs, poteaux, planchers, hauteurs, implantation précise
  des ouvertures.
- Ne pas faire de calcul structure, ni de dimensionnement charpente.
- Ne pas modifier les boîtes des autres agents.
- Ne pas démarrer une mission toiture-charpente ou documentation.

## Livrable attendu

1. Ouvrir le fichier Revit existant `D:\CLIENT\Ringo\Plan\Projet1.rvt`.
2. Mettre en place les niveaux : sol, RDC, R+1, toiture / ligne de bris.
3. Modéliser le volume 4,00 x 8,00 m et la toiture selon le cadrage ci-dessus.
4. Préparer des vues client lisibles : plan, coupe, élévations et 3D.
5. Rédiger un court rapport de fin de mission dans ta boîte retour, avec :
   - ce qui a été créé ;
